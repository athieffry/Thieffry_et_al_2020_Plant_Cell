...
computeMatrix scale-regions \
        ...
        -o matrix_RNAseq_minus_BED_minus \
        --outFileNameMatrix matrix_RNAseq_minus_BED_minus.mat


# plot average profile
plotProfile -m matrix_RNAseq_minus_BED_minus \
        -o profiles_RNAseq_minus_BED_minus.pdf \
        --averageType median \
        --perGroup \
...
# plot heatmap
#plotHeatmap -m matrix_RNAseq_minus_BED_minus \
#        -o heatmap_RNAseq_minus_BED_minus.pdf \
#        --sortRegions descend \
#        --sortUsing mean \
