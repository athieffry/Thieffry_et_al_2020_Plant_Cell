...
computeMatrix scale-regions \
        ...
        -o matrix_RNAseq_plus_BED_plus \
        --outFileNameMatrix matrix_RNAseq_plus_BED_plus.mat


# plot average profile
plotProfile -m matrix_RNAseq_plus_BED_plus \
        -o profiles_RNAseq_plus_BED_plus.pdf \
        --averageType median \
        --perGroup \
...
# plot heatmap
#plotHeatmap -m matrix_RNAseq_plus_BED_plus \
#        -o heatmap_RNAseq_plus_BED_plus.pdf \
#        --sortRegions descend \
#        --sortUsing mean \
